...
<div class="h-full w-full pb-16 px-4">
    ...
    <div class="flex flex-col items-center justify-center">
        ...
        <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-5 shadow-2xl">
            <p tabindex="0" class="focus:outline-none text-2xl font-extrabold leading-6 text-gray-800 mb-4">Daftarkan akun Anda</p>
            ...
            <form action="<?= base_url('Auth/register') ?>" method="POST">
                <div>
                    ...
                    <input aria-labelledby="name" type="text" name="name" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                </div>
                <div>
                ...
                <div>
                    <label id="telp" class="text-sm font-medium leading-none text-gray-800">
                        Telepon
                    </label>
                    <input aria-labelledby="telp" type="number" name="telp" minlength="11" maxlength="12" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                </div>
                ...
                <div class="mt-8">
                    <button role="button" type="submit" onclick="return validatePhone()" class="focus:ring-2 focus:ring-offset-2 text-sm font-semibold leading-none text-white focus:outline-none border rounded py-4 w-full btn-login">Mendaftar</button>
                </div>
            </form>
    ...
    function validatePhone() {
        ...
        if (phone.length < 11 || phone.length > 12) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Nomor telepon harus memiliki panjang antara 11 dan 12 digit.',
            });
            return false;
        }
        return true;
